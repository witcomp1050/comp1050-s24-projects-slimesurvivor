...
public class Map3Controller implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		ArrayList<ImageView> env = new ArrayList<ImageView>(Arrays.asList(topRiver, botRiver,
				rock, rock1, rock2, rock3, rock4, rock5, rock6, rock7, rock8));
		p1 = new Player(400, 400, 1, p1Image, MapPane);
	    ...
	    Animationtimer = new AnimationTimer() {
			...
			public void handle(long now) {
				...
				if(p1.getHealth()<=0) {
					this.stop();
					updateHS();
					viewSwitcher.switchTo(View.MAP3ENDSCREEN);
				}
				if(p1.levelUp) {
					this.stop();
					lvlUpMenu();
